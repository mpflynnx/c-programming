...
- [Variable types and using printf & scanf](/docs/variable-types-and-using-printf-scanf.md)
    ...
    - [Modifiers](/docs/variable-types-and-using-printf-scanf.md#modifiers)
...
- [printf](/docs/printf.md)
    ...
    - [printf placeholders specifiers](/docs/printf.md#printf-placeholders-specifiers)
...
- [For loops](/docs/for-loops.md)
    ...
    - [for loop with break](/docs/for-loops.md#for-loop-with-break)
    - [for loop with continue](/docs/for-loops.md#for-loop-with-continue)
